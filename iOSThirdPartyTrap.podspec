#
# Be sure to run `pod lib lint iOSThirdPartyTrap.podspec' to ensure this is a
...
Resolve some bug or provide convenient wrap source of third party library.
  ...
  s.source           = { :git => 'https://github.com/ItghostFan/iOSThirdPartyTrap.git', :tag => s.version.to_s }
